<template>
  <form class="u-move-below-header u-full-width-content u-align-center" @submit.prevent="authenticate()">
    ...
    <p>Due to privacy reasons, please <a href="https://www.linkedin.com/in/mehreenstavri" class="highlight underline">contact me</a> for log in details to view samples of my work.</p>
